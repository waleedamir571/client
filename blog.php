...
<main class="site-content" id="content">
      ...
      <section class="breadcrumb_area" data-bg-image="images/breadcrumb/breadcrumb-bg.jpg" data-bg-color="#140C1C">
         <div class="container">
            <div class="row">
               <div class="col">
                     ...
                     <article class="tj-post wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div class="tj-post__content">
                           ...
                           <h3 class="tj-post__title entry-title">
                              <a href="blog-details.php">The Role of Technology in Modern Logistics Management</a>
                           </h3>
                           ...
                           <div class="tj-post__btn">
                              <a href="blog-details.php" class="tj-btn-primary">Read more</a>
                           </div>
                        </div>
                     </article>
                     ...
                     <article class="tj-post wow fadeInUp" data-wow-delay=".3s">
                        <div class="tj-post__thumb">
                           ...
                           <div class="tj-post__video">
                              <a href="https://player.vimeo.com/video/364758150" class="popup_video"><i class="fa-thin fa-circle-play"></i></a>
                           </div>
                           ...
                           <li>
                              ...
                              <div class="recent-post_content">
                                 ...
                                 <h4 class="recent-post_title">
                                    <a href="blog-details.php">Definition and Principles of JIT Logistics</a>
                                 </h4>
                              </div>
                           </li>
                           <li>
                              ...
                              <div class="recent-post_content">
                                 ...
                                 <h4 class="recent-post_title">
                                    <a href="blog-details.php">Real-world Examples of Successful JIT Logistics</a>
                                 </h4>
                              </div>
                           </li>
                           <li>
