   ...
   <main class="site-content" id="content">
               ...
               <div class="col-md-6">
                  <div class="hero-content-box">
                     ...
                     <div class="hero-image-box d-md-none text-center">
                        <img src="images/JD99gw4J3Sww.png" alt="">
                     </div>
      ...
      <div id="service-wrapper" class="popup_content_area zoom-anim-dialog mfp-hide" data-lenis-prevent="">
         <div class="popup_modal_img">
            <img src="images/oxGUGCSWiMAO.jpg" alt="">
         </div>
      ...
      <div id="portfolio-wrapper" class="popup_content_area zoom-anim-dialog mfp-hide" data-lenis-prevent="">
         <div class="popup_modal_img">
            <img src="images/AVVIY8SAxa8u.jpg" alt="">
         </div>
         <div class="popup_modal_content">
            ...
            <div class="portfolio_gallery owl-carousel">
               <div class="gallery_item">
                  <img src="images/6VTO2ZmmSMYi.jpg" alt="">
               </div>
               <div class="gallery_item">
                  <img src="images/LfC1TCWKWazu.jpg" alt="">
               </div>
               <div class="gallery_item">
                  <img src="images/JDOT3hPBqKxy.jpg" alt="">
               </div>
               <div class="gallery_item">
                  <img src="images/AwSiGMSKrMnB.jpg" alt="">
               </div>
            </div>
                  ...
                  <div class="skills-widget d-flex flex-wrap justify-content-center align-items-center">
                     <div class="skill-item wow fadeInUp" data-wow-delay=".3s">
                        <div class="skill-inner">
                           <div class="icon-box">
                              <img src="images/XlGmNXttHyks.svg" alt="">
                           </div>
                     ...
                     <div class="skill-item wow fadeInUp" data-wow-delay=".4s">
                        <div class="skill-inner">
                           <div class="icon-box">
                              <img src="images/6bhv64zpp8mZ.svg" alt="">
                           </div>
                     ...
                     <div class="skill-item wow fadeInUp" data-wow-delay=".5s">
                        <div class="skill-inner">
                           <div class="icon-box">
                              <img src="images/AvVfs1M3IEN7.svg" alt="">
                           </div>
                     ...
                     <div class="skill-item wow fadeInUp" data-wow-delay=".6s">
                        <div class="skill-inner">
                           <div class="icon-box">
                              <img src="images/BStpsvpHnsjZ.svg" alt="">
                           </div>
                     ...
                     <div class="skill-item wow fadeInUp" data-wow-delay=".7s">
                        <div class="skill-inner">
                           <div class="icon-box">
                              <img src="images/UIhyxzy5nAcY.svg" alt="">
                           </div>
                     ...
                     <div class="skill-item wow fadeInUp" data-wow-delay=".8s">
                        <div class="skill-inner">
                           <div class="icon-box">
                              <img src="images/thCZygabAndL.svg" alt="">
                           </div>
                     ...
                     <div class="owl-carousel testimonial-carousel">
                        <div class="testimonial-item">
                           <div class="top-area d-flex flex-wrap justify-content-between">
                              <div class="logo-box">
                                 <img src="images/i3z1oFilF8aT.png" alt="">
                              </div>
                              <div class="image-box">
                                 <img src="images/dP4CkOQfEJfV.jpg" alt="">
                              </div>
                           </div>
                           <div class="icon-box">
                        ...
                        <div class="testimonial-item">
                           <div class="top-area d-flex flex-wrap justify-content-between">
                              <div class="logo-box">
                                 <img src="images/xlW7cTNN44Ww.png" alt="">
                              </div>
                              <div class="image-box">
                                 <img src="images/F2X35sGkM6Ya.jpg" alt="">
                              </div>
                           </div>
                           <div class="icon-box">
                              <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="row">
                  ...
                  <div class="blog-item wow fadeInUp" data-wow-delay=".5s">
                     <div class="blog-thumb">
                        <a href="blog-details.html">
                           <img src="images/bFJWWlqlgtA2.jpg" alt="">
                        </a>
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="blog-item wow fadeInUp" data-wow-delay=".6s">
                     <div class="blog-thumb">
                        <a href="blog-details.html">
                           <img src="images/x618TgZHhTq5.jpg" alt="">
                        </a>
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="blog-item wow fadeInUp" data-wow-delay=".7s">
                     <div class="blog-thumb">
                        <a href="blog-details.html">
                           <img src="images/1ElfDywVQtu2.jpg" alt="">
                        </a>
